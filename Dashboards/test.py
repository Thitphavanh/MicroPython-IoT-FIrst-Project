...
#############DOOR##############
# วาดหลายเหลี่ยม
canvas.create_polygon([630,426,675,450,675,495,629,470],fill='#0ff717',width=1,outline=None,tags='d1') ### 2
# ใส่ข้อความ
canvas.create_text(300,300,text='ประตูฟาร์มกำลังเปิด',fill='green',font=('Angsana New',30,'bold'),tags='d1') ### 3
# ใส่ LINE
canvas.create_line(425,320,640,455,fill='grey',width=4,tags='d1') ### 4
